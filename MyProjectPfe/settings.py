"""
Django settings for MyProjectPfe project.
...
SECRET_KEY = 'django-insecure-%-q%2u%_!1#=898ax@@%1xc*@+0-a$!gy$i2jz%hk92ms$8w&x'
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware',  # Placé juste après SecurityMiddleware
...
ROOT_URLCONF = 'MyProjectPfe.urls'
...
WSGI_APPLICATION = 'MyProjectPfe.wsgi.application'
